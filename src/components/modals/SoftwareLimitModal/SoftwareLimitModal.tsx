...
const SoftwareLimitModal: React.FC = () => {
    ...
    return (
            <Dialog.Content className="fixed top-1/2 left-1/2 bg-backgroundPrimary p-6 rounded-lg border border-white h-[37%] w-[25%] shadow-xl transform -translate-x-1/2 -translate-y-1/2 animate-fade-in">

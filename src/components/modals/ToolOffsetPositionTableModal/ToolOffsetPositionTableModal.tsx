            ...
            <React.Fragment key={rowIndex}>
              ...
              {[0, 1].map((colIndex) => (
                <input
                  ...
                  className="h-[100%] w-[100%] p-2 border border-gray-500 rounded text-center text-[85%] bg-backgroundPrimary text-white focus:outline-none focus:border-white focus:border-1 focus:shadow-md [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                />
              ))}

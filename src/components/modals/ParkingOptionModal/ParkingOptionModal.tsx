    ...
    return (
            <Dialog.Content className="fixed top-1/2 left-1/2 bg-backgroundPrimary p-6 rounded-lg border border-white h-[31vh] w-[20vw] shadow-xl transform -translate-x-1/2 -translate-y-1/2 animate-fade-in">
                ...
                <div className="w-[100%] h-full mx-auto flex flex-col justify-between">
                    <button className="h-[14%] w-full bg-primary text-white px-4 py-2 rounded-md cursor-pointer text-[130%] font-bold transition-colors duration-200 mt-applyButtonTopMargin hover:bg-buttonHover flex items-center justify-center text-center">Apply</button>
                </div>
            </Dialog.Content>
    );
};
